...
def subject_tr(request):
   ...
   for i in dd:
       ...
       for th,kj in zip(a,b):
           if (th == i.Course_title) and (kj == i.Subject_title):
               cmt += 1
           if cmt == 0:
...
def ch_co_tr(request):
    ...
    return render(request, 'chapter_content.html', {'mm1': mm1})
...
def stu_buk_acc(request):
    ...
    return render(request,'student_booked_details.html',{'stzz':stzz})
...
def stu_sub_selnew(request):
    ...
    return render(request, 'student_sub_selctnew.html',{'snew':snew})
...
def st_sub_selnew2(request):
    ...
    return render(request, 'student_sub_selctnew2.html', {'snew1': snew1})
...
def disp_teach(request):
    ...
    return render(request,'display_teacher.html',{'ds':ds})
...
def st_book_courses(request):
    ...
    return render(request, 'student_book_courses.html',{'buk':buk,'st':st})
...
def acc_chapter(request, id, ikm, sub):
    ...
    return render(request, 'accept_chapter.html', {'fd':fd})
...
def acc_chapter1(request):
    ...
    return render(request, 'accept_chapter2.html', {'ded': ded})
...
def del_msg_student(request,id):
    ...
    return render(request,'m_m2.html',{'bb':bb})
...
def reply_teacher(request,id):
    ...
    if request.method == 'POST':
        ...
        messages.success(request, 'Message reply successful')
        return redirect('m_m')
    return render(request,'reply_teacher.html',{'pa':pa})
...
def upl_cer(request):
    ...
    return render(request,'upl_cer.html',{'ms':ms})
...
def subject_ad(request):
   ...
   return render(request,'subject_ad.html',{'grg':grg})
...
def chapter_ad(request):
    ...
    return render(request, 'chapter_ad.html', {'grg1': grg1})
...
def ch_co_ad(request):
    ...
    return render(request, 'ch_co_ad.html', {'gt':gt,'dm':dm})
